...
type SearchHostResponse struct {
	...
	Status *common.ResponseStatus `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	// 主机信息
	Instance             []*TopologyObject `protobuf:"bytes,3,rep,name=instance,proto3" json:"instance,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SearchHostResponse) GetInstance() []*TopologyObject {
	if m != nil {
		return m.Instance
	}
	return nil
...
type SearchLakeAreaRequest struct {
	HostIp               []string `protobuf:"bytes,1,rep,name=host_ip,json=hostIp,proto3" json:"host_ip,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SearchLakeAreaRequest) GetHostIp() []string {
	if m != nil {
		return m.HostIp
	}
	return nil
...
type SearchLakeAreaResponse struct {
	RoomIp []*RoomAndIP `protobuf:"bytes,1,rep,name=room_ip,json=roomIp,proto3" json:"room_ip,omitempty"`
	// 状态码
	Status               *common.ResponseStatus `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
...
func (m *SearchLakeAreaResponse) GetRoomIp() []*RoomAndIP {
	if m != nil {
		return m.RoomIp
	}
	return nil
...
type RoomAndIP struct {
	HostIp               string          `protobuf:"bytes,1,opt,name=host_ip,json=hostIp,proto3" json:"host_ip,omitempty"`
	Room                 []*RoomAreaTopo `protobuf:"bytes,2,rep,name=room,proto3" json:"room,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *RoomAndIP) Reset()         { *m = RoomAndIP{} }
func (m *RoomAndIP) String() string { return proto.CompactTextString(m) }
func (*RoomAndIP) ProtoMessage()    {}
func (*RoomAndIP) Descriptor() ([]byte, []int) {
	return fileDescriptor_02e1f4eaffd389ae, []int{52}
}

func (m *RoomAndIP) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RoomAndIP.Unmarshal(m, b)
}
func (m *RoomAndIP) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RoomAndIP.Marshal(b, m, deterministic)
}
func (m *RoomAndIP) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RoomAndIP.Merge(m, src)
}
func (m *RoomAndIP) XXX_Size() int {
	return xxx_messageInfo_RoomAndIP.Size(m)
}
func (m *RoomAndIP) XXX_DiscardUnknown() {
	xxx_messageInfo_RoomAndIP.DiscardUnknown(m)
}

var xxx_messageInfo_RoomAndIP proto.InternalMessageInfo

func (m *RoomAndIP) GetHostIp() string {
	if m != nil {
		return m.HostIp
	}
	return ""
...
func (m *RoomAndIP) GetRoom() []*RoomAreaTopo {
	if m != nil {
		return m.Room
	}
	return nil
...
type RoomAreaTopo struct {
	...
	// 地区信息
	Child                *AreaTopo `protobuf:"bytes,8,opt,name=child,proto3" json:"child,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *RoomAreaTopo) Reset()         { *m = RoomAreaTopo{} }
func (m *RoomAreaTopo) String() string { return proto.CompactTextString(m) }
func (*RoomAreaTopo) ProtoMessage()    {}
func (*RoomAreaTopo) Descriptor() ([]byte, []int) {
	return fileDescriptor_02e1f4eaffd389ae, []int{53}
}

func (m *RoomAreaTopo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RoomAreaTopo.Unmarshal(m, b)
}
func (m *RoomAreaTopo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RoomAreaTopo.Marshal(b, m, deterministic)
}
func (m *RoomAreaTopo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RoomAreaTopo.Merge(m, src)
}
func (m *RoomAreaTopo) XXX_Size() int {
	return xxx_messageInfo_RoomAreaTopo.Size(m)
}
func (m *RoomAreaTopo) XXX_DiscardUnknown() {
	xxx_messageInfo_RoomAreaTopo.DiscardUnknown(m)
}

var xxx_messageInfo_RoomAreaTopo proto.InternalMessageInfo

func (m *RoomAreaTopo) GetBkInstId() int32 {
	if m != nil {
		return m.BkInstId
	}
	return 0
...
func (m *RoomAreaTopo) GetRoomName() string {
	if m != nil {
		return m.RoomName
	}
	return ""
...
func (m *RoomAreaTopo) GetAreaCode() string {
	if m != nil {
		return m.AreaCode
	}
	return ""
...
func (m *RoomAreaTopo) GetChild() *AreaTopo {
	if m != nil {
		return m.Child
	}
	return nil
...
type AreaTopo struct {
	Area                 *AreaObject `protobuf:"bytes,1,opt,name=area,proto3" json:"area,omitempty"`
	Child                *AreaTopo   `protobuf:"bytes,2,opt,name=child,proto3" json:"child,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}

func (m *AreaTopo) Reset()         { *m = AreaTopo{} }
func (m *AreaTopo) String() string { return proto.CompactTextString(m) }
func (*AreaTopo) ProtoMessage()    {}
func (*AreaTopo) Descriptor() ([]byte, []int) {
	return fileDescriptor_02e1f4eaffd389ae, []int{54}
}

func (m *AreaTopo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AreaTopo.Unmarshal(m, b)
}
func (m *AreaTopo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AreaTopo.Marshal(b, m, deterministic)
}
func (m *AreaTopo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AreaTopo.Merge(m, src)
}
func (m *AreaTopo) XXX_Size() int {
	return xxx_messageInfo_AreaTopo.Size(m)
}
func (m *AreaTopo) XXX_DiscardUnknown() {
	xxx_messageInfo_AreaTopo.DiscardUnknown(m)
}

var xxx_messageInfo_AreaTopo proto.InternalMessageInfo

func (m *AreaTopo) GetArea() *AreaObject {
	if m != nil {
		return m.Area
	}
	return nil
...
func (m *AreaTopo) GetChild() *AreaTopo {
	if m != nil {
		return m.Child
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RoomAndIP)(nil), "cmdb.RoomAndIP")
	proto.RegisterType((*RoomAreaTopo)(nil), "cmdb.RoomAreaTopo")
	proto.RegisterType((*AreaTopo)(nil), "cmdb.AreaTopo")
}
...
var fileDescriptor_02e1f4eaffd389ae = []byte{
	...
	,
}
