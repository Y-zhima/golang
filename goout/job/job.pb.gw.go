...
var (
	pattern_Job_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "job", "create"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Job_Filter_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "job", "filter"}, "", runtime.AssumeColonVerbOpt(true)))
)
