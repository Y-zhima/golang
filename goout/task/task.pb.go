...
type InstallServerRequest struct {
	...
	// 主机查询条件
	Cmdb_HostSearchRequest *cmdb.ChooseHostRequest `protobuf:"bytes,4,opt,name=cmdb__host_search_request,json=cmdbHostSearchRequest,proto3" json:"cmdb__host_search_request,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                `json:"-"`
	XXX_unrecognized       []byte                  `json:"-"`
	XXX_sizecache          int32                   `json:"-"`
}
...
func (m *InstallServerRequest) GetCmdb_HostSearchRequest() *cmdb.ChooseHostRequest {
	if m != nil {
		return m.Cmdb_HostSearchRequest
	}
	return nil
}
...
var fileDescriptor_8e8f2b86464a95fe = []byte{
	...
	,
}
