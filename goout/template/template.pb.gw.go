...
var (
	filter_Template_Get_0 = &utilities.DoubleArray{Encoding: map[string]int{"template_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func RegisterTemplateHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TemplateClient) error {
	...
	mux.Handle("POST", pattern_Template_UpdateState_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_Template_UpdateState_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Template_UpdateState_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_Template_UpdateState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "template", "updateState", "template_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_Template_UpdateState_0 = runtime.ForwardResponseMessage
)
