...
// Source: git.fogcdn.top/axe/protos/goout/greeter (interfaces: GreeterClient)
...
import (
	context "context"
	greeter "git.fogcdn.top/axe/protos/goout/greeter"
...
func (m *MockGreeterClient) SayHello(arg0 context.Context, arg1 *greeter.HelloRequest, arg2 ...grpc.CallOption) (*greeter.HelloReply, error) {
	m.ctrl.T.Helper()
